...
public class BillDialog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dcCreatedDate.setDateFormatString("dd/MM/yyyy");
        ...
        dcSubmittedDate.setDateFormatString("dd/MM/yyyy");
        ...
        dcECreatedDate.setDateFormatString("dd/MM/yyyy");
        ...
        dcESubmittedDate.setDateFormatString("dd/MM/yyyy");
        ...
        dcWCreatedDate.setDateFormatString("dd/MM/yyyy");
        ...
        dcWSubmittedDate.setDateFormatString("dd/MM/yyyy");
    ...
    private void refreshIDStudent() {
        ArrayList<String> arr = StudentController.getListIDStudentOnRoom(
                cbRoom.getSelectedItem().toString().trim()
                + cbBuilding.getSelectedItem().toString().trim()
        );
        cbStudent.setModel(new javax.swing.DefaultComboBoxModel<>(new String[]{}));
        arr.forEach(string -> {
