...
public class StudentDialog extends javax.swing.JFrame {
    ...
    private String checkSyntax() {
        ...
        long l = 5049216;
        l *= 100000;
        if (date.getTime() - dcBirthday.getDate().getTime() < l) {
            return ("Sinh viên chưa đủ tuổi (16)");
        }
    ...
    private void initComponents() {
        ...
        setResizable(false);
        setSize(new java.awt.Dimension(734, 824));
        ...
        dcBirthday.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        dcComeDate.setDateFormatString("dd/MM/yyyy");
        dcComeDate.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N

        dcExpDate.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        dcExpDate.setDate(new Date());
        dcExpDate.setDateFormatString("dd/MM/yyyy");
        dcExpDate.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        txtBHYT.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        txtNationality.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        txtNation.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        txtPersonalName.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        txtPersonalPhone.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        txtPersonalAddress.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (add) {
            ...
            if (StudentController.updateData(s)) {
                // Nếu đổi CMND/CCCD thì xóa tài khoản cũ thêm tài khoản mới
                if (!oldCMND.trim().equals(s.getIDCard().trim())) {
    ...
    private void cbIDBuildingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbIDBuildingActionPerformed
        // Xử lí cập nhật lại số phòng khi thay đổi tòa
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        try {
            ...
            JasperDesign jd = JRXmlLoader.load("src/org/report/Para_IDSinhVien.jrxml");
            JasperReport jr = JasperCompileManager.compileReport(jd);
            HashMap hm = new HashMap();
            hm.put("MaSV", Integer.valueOf(txtIDStudent.getText().trim()));
    ...
    private void cbSexActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSexActionPerformed
        if (cbSex.getSelectedIndex() != -1) {
            ArrayList<String> arr = BuildingController.getListBuilding(cbSex.getSelectedItem().toString());
            cbIDBuilding.setModel(new javax.swing.DefaultComboBoxModel<>(new String[]{}));
            arr.forEach(string -> {
                cbIDBuilding.addItem(string);
            });
            refreshNumRoom();
