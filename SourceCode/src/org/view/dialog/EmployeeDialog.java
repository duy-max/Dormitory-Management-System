...
public class EmployeeDialog extends javax.swing.JFrame {
    ...
    private String checkSyntax() {
        System.out.println(dcBirthday.getDate().getTime());
        ...
        long l = 56808;
        l *= 10000000;
        if (dcWorkingDate.getDate().getTime() - dcBirthday.getDate().getTime() < l) {
    ...
    private void initComponents() {
        ...
        lbIDEmployee.setText("Mã số nhân viên");

        txtIDEmployee.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        dcWorkingDate.setDateFormatString("dd/MM/yyyy");
        dcWorkingDate.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtIDCard, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(panelWE, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        try {
            // TODO add your handling code here:
            JasperDesign jd = JRXmlLoader.load("src/org/report/Para_IDNhanVien.jrxml");
            JasperReport jr = JasperCompileManager.compileReport(jd);
            HashMap hm = new HashMap();
            hm.put("MaNV", txtIDEmployee.getText().trim());
