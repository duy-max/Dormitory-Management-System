...
public class DepartmentDialog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Chỉnh sửa thông tin Phòng ban");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (add) {
            ...
            if (DepartmentController.updateData(d, oldIDManager)) {
                MetroUI.notificate("Thông báo", "Sửa thành công", TrayIcon.MessageType.INFO);
            } else {
                MetroUI.notificate("Thông báo", "Sửa thất bại", TrayIcon.MessageType.ERROR);
            }
        }
