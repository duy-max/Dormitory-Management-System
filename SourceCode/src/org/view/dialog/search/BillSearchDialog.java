...
public class BillSearchDialog extends javax.swing.JFrame {
    ...
    private void actionSearch() {
        ...
        BillPanel.getInstance().setTableModel(BillController.getFilterModel());
        BillPanel.getInstance().resizeColumnTable();
        if (BillPanel.getInstance().getTableModel().getRowCount() == 0) {
            MetroUI.notificate(
    ...
    private void initComponents() {
        ...
        txtInvoiceDate.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        txtCollectionDate.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        txtKind.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
