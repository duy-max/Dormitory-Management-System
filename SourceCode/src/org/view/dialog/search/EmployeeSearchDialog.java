...
public class EmployeeSearchDialog extends javax.swing.JFrame {
    ...
    private void actionSearch() {
        ...
        EmployeePanel.getInstance().setTableModel(EmployeeController.getFilterModel());
        EmployeePanel.getInstance().resizeColumnTable();

        if (EmployeePanel.getInstance().getTableModel().getRowCount() == 0) {
            MetroUI.notificate(
    ...
    private void initComponents() {
        ...
        txtDepartment.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        txtWorkingDate.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtIDCard, txtIDEmployee});
