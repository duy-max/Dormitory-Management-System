...
public class RoomSearchDialog extends javax.swing.JFrame {
    ...
    private void actionSearch() {
        RoomManageController.searchData(
                txtBuilding.getText(), 
                txtId.getText(),
                txtFacility.getText(), 
                txtType.getText(), 
        ...
        RoomPanel.getInstance().setTableModel(RoomManageController.getFilterModel());
        RoomPanel.getInstance().resizeColumnTable();
