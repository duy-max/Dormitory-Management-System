...
import org.view.dialog.EmployeeDialog;
import org.view.dialog.StudentDialog;
import org.view.dialog.search.EmployeeSearchDialog;
...
public class EmployeePanel extends JPanel implements Panel {
 ...
 public void resizeColumnTable() {
        ...
        this.viewTable.getColumnModel().getColumn(1).setMinWidth(100);
        this.viewTable.getColumnModel().getColumn(2).setMinWidth(150);
        this.viewTable.getColumnModel().getColumn(3).setMinWidth(100);
        this.viewTable.getColumnModel().getColumn(4).setMinWidth(150);
        this.viewTable.getColumnModel().getColumn(5).setMinWidth(100);
        this.viewTable.getColumnModel().getColumn(6).setMinWidth(100);
        this.viewTable.getColumnModel().getColumn(7).setMinWidth(100);
        this.viewTable.getColumnModel().getColumn(8).setMinWidth(200);
    }
    @Override
    ...
    public void reloadTable() {
        EmployeeController.initialData();
        EmployeeController.initialModel();
        viewTable.setModel(EmployeeController.getModel());
        resizeColumnTable();
    }

    @Override
    public void actionAdd() {
        new EmployeeDialog(null).setVisible(true);
    }
    ...
    public void actionEdit() {
        ...
        new EmployeeDialog(EmployeeController.showFullInfo(t)).setVisible(true);
    }
    ...
    public void actionDelete() {
        ...
        count = 0;
        for (String s : arr) {
            if (EmployeeController.delData(s)) {
                ++count;
            }
        }
        MetroUI.notificate(
                "Thông báo",
                "Đã xóa " + count + " nhân viên",
    ...
    public void actionPrint() {
        try {
            ...
            JasperDesign jd = JRXmlLoader.load("src/org/report/Para_DanhSachNhanVien.jrxml");
    ...
    public void actionAdvancedSearch() {
        new EmployeeSearchDialog().setVisible(true);
    }
